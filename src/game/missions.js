...
export const PLANETS = [
  {
    ...
    briefing: 'The rover has arrived on Mercury. Use the control panel to help the rover complete its missions.',
    missions: [
      {
        objective: 'Navigate the rover back to the spacecraft for refueling.',
        hint: 'Click on a function to add it to the rover\'s program. Click "Submit Instructions" when the program is ready to run.',
        blocks: [
        ...
        criteria: [
          {category: 'rover_x', value: 500, message: 'The rover did not make it back to spacecraft.'}
        ]
      },
      {
        ...
        criteria: [
          {category: 'rover_x', value: 400, message: 'The rover did not make it close enough to crater.'}
        ]
      },
      {
        ...
        criteria: [
          {category: 'rover_x', value: 100, message: 'The rover did not make it back to rocket.'},
          {category: 'rover_carry', value: 'rock', message: 'The rover does not have rock sample.'},
        ]
      },
      {
    ...
    missions: [
      {
        ...
        criteria: [
          {category: 'photograph', value: 700, message: 'The rover did not take photograph of volcano.'},
        ]
      },
      {
      ...
      },
      {
        ...
        criteria: [
          {category: 'photograph', value: 200, message: 'The rover did not take photograph of all volcano.'},
          {category: 'photograph', value: 300, message: 'The rover did not take photograph of all volcano.'},
          {category: 'photograph', value: 400, message: 'The rover did not take photograph of all volcano.'},
          {category: 'photograph', value: 500, message: 'The rover did not take photograph of all volcano.'},
          {category: 'photograph', value: 600, message: 'The rover did not take photograph of all volcano.'},
        ]
      },
      {
        objective: 'Drop off both rock samples at the rocket.',
        hint: 'The rover can only hold one object at a time.',
        blocks: [
          [BLOCK_NAMES.FORWARD, 5],
          [BLOCK_NAMES.TURN, 1],
          [BLOCK_NAMES.BRIDGE, 1],
  ...
  },
  {
    ...
    briefing: 'The rover has arrived on Earth. Deliver the rock samples to the lab before proceeding to the next planet.',
    missions: [
      {
        ...
        criteria: [
          {category: 'button_press', id: 'button1', value: true, message: 'The rover did not press all blue buttons.'},
          {category: 'button_press', id: 'button2', value: false, message: 'The rover pressed a red button.'},
          {category: 'button_press', id: 'button3', value: true, message: 'The rover did not press all blue buttons.'},
        ]
      },
      {
  ...
  },
  {
    ...
    briefing: 'The rover has arrived on Mars, the last planet on this journey.',
    missions: [
      {
        objective: 'Take a photograph at the base of the mountain.',
        hint: 'The rover store data in variables, found in the upper right. Some instructions let you type the name of a variable to control how the instruction behaves.',
        variables: [
          {name: 'x', value: 0},
        ],
        blocks: [
        ...
        criteria: [
          {category: 'photograph', value: 500, message: 'The rover did not take photograph of mountain.'},
        ]
      },
      {
        ...
        criteria: [
          {category: 'variable', id: 'x', value: 2, message: 'The rover did not calculate x correctly.'},
        ]
      },
      {
        ...
        criteria: [
          {category: 'photograph', value: 200, message: 'The rover did not take a photograph of each mountain.'},
          {category: 'photograph', value: 400, message: 'The rover did not take a photograph of each mountain.'},
          {category: 'photograph', value: 700, message: 'The rover did not take a photograph of each mountain.'},
          {category: 'max_photographs', value: 3, message: 'The rover took too many photographs.'},
        ]
      },
      {
