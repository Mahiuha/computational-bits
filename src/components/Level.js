    ...
    switch (instruction.block) {
      ...
      case BLOCK_NAMES.PRESS_BUTTON:
        ...
        if (obj !== null) {
          ...
          setState(state => ({
            ...state,
           loseMessage: 'The rover tried to press a button that wasn\'t there.'
          }));
        }
        break;
      ...
      case BLOCK_NAMES.BRIDGE:
        ...
        if (canBuildBridge(bridgeX)) {
          ...
          setState(state => ({
            ...state,
           loseMessage: 'The rover can only build bridges over craters.'
          }));
        }
        break;
    ...
    if (i === roverIndex && programSubmitted) {
      if (checkFall(item)) {
        setState(state => ({
          ...
          loseMessage: 'The rover fell into crater.'
        }));
        return;
      }
    }
